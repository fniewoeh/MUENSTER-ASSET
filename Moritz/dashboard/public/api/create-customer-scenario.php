...
try {
    ...
    $storageDir = dirname(__DIR__, 2) . DIRECTORY_SEPARATOR . 'Moritz-data' . DIRECTORY_SEPARATOR . 'customer-scenarios';
    ...
    respond(201, [
        'id' => $scenarioId,
        'path' => '/Moritz-data/customer-scenarios/' . $scenarioId . '.json',
    ]);
} catch (JsonException) {
