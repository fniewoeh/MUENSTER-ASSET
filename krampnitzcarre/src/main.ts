...
const CONFIG_STORAGE_KEY = 'krampnitzcarre-runtime-config'
const PREVIEW_PRESET_STORAGE_KEY = 'krampnitzcarre-preview-preset'
const PREVIEW_PRESET_QUERY_KEY = 'previewPreset'
const DEFAULT_PRESET_ID = 'krampnitzcarre-default'
...
const MAPS_URL = 'https://www.krampnitz-carree.de'
const PROJECT_VIDEO_URL = 'https://www.youtube.com/watch?v=dOQiADZ7UvU'
...
const CUSTOMER_SCENARIO_DATA_ROOT = '/Krampnitzcarre-data/customer-scenarios'
...
const heroSlides: HeroSlide[] = [
  {
    image: '/project/hero-krampnitz-cover.png',
    alt: 'Krampnitz Carré in Potsdam',
    caption: 'Krampnitz Carré in Potsdam',
  },
]
              ...
              <div class="config-grid config-grid-compact">
                <label class="config-field">
                  ...
                  <span class="config-field-hint">
                    Wird als Dateiname und URL-Parameter genutzt, z. B. krampnitzcarre-aerzte-01.
                  </span>
                  <div class="config-input-wrap">
                    <input
                      ...
                      spellcheck="false"
                      autocomplete="off"
                      placeholder="krampnitzcarre-aerzte-01"
                    />
                  </div>
                </label>
                <label class="config-field">
                  ...
                  <div class="config-input-wrap">
                    <input
                      ...
                      type="text"
                      autocomplete="off"
                      placeholder="Krampnitzcarre Ärzte 01"
                    />
                  </div>
                </label>
              </div>
  ...
  <main class="page">
    <section class="panel hero${appMode === 'customer' ? ' hero-customer' : ''}">
      ...
      <div class="hero-content">
        <p class="eyebrow">Krampnitz Carré Potsdam</p>
        ...
        <p class="lead">
          Denkmalobjekt in Potsdam: Wählen Sie eine der 6 freien Einheiten und erhalten Sie sofort eine
    ...
    <section class="journey-strip" aria-label="So funktioniert der Immobilien-Check">
      <article class="journey-step">
        ...
        <div>
          ...
          <p class="journey-step-copy">Eine der 6 freien Einheiten auswählen und den Zuschnitt direkt vergleichen.</p>
        </div>
      </article>
      <article class="journey-step">
    ...
    <section class="workspace">
      <section class="panel choose-panel">
        <h2>1. Wählen Sie Ihre freie Einheit</h2>
    ...
    <section class="panel facts-panel">
      <h2>Ein paar schnelle Fakten zum Krampnitz Carré.</h2>
      <p class="lead">
        Das Projekt verbindet Denkmalcharakter, KfW-Förderkulisse und einen klaren Abverkaufsstand:
        aktuell stehen noch 6 Einheiten zur Verfügung.
      </p>
      <div class="facts-grid">
        <article class="fact-card">
          <p class="fact-number">6</p>
          <p class="fact-title">freie Einheiten aktuell</p>
          <div class="fact-bar">
            <div class="fact-fill fact-fill-demand" style="width: 24%"></div>
          </div>
          <p class="fact-copy">Ausgewählt auf Basis deiner aktuellen Einheitenliste.</p>
        </article>

        <article class="fact-card">
          <p class="fact-number">45,05-74,60 m²</p>
          <p class="fact-title">verfügbare Größen</p>
          <div class="compare-row">
            <span>kleinste Einheit: 45,05 m²</span>
            <span>größte Einheit: 74,60 m²</span>
          </div>
          <div class="fact-bar">
            <div class="fact-fill fact-fill-single" style="width: 74.6%"></div>
          </div>
        </article>

        <article class="fact-card">
          <p class="fact-number">424.000-665.000 EUR</p>
          <p class="fact-title">Kaufpreisspanne</p>
          <div class="compare-row">
            <span>günstigster Einstieg: 424.000 EUR</span>
            <span>höchster Kaufpreis: 665.000 EUR</span>
          </div>
          <div class="dual-bars">
            <div class="dual-bar">
        ...
        <article class="fact-card">
          <p class="fact-number">Baudenkmal + KfW EH70 EE WPB</p>
...
function getMaxKfwLoan(_apartment: ApartmentOption, totalInvestment: number, defaultKfwLoanAmount: number): number {
  return Math.min(defaultKfwLoanAmount, totalInvestment)
}
...
function buildEmbeddedDefaultPreset(sourceConfig: CalculationConfig): RuntimePreset {
  ...
  return {
    ...
    label: 'Krampnitzcarre Standard',
    version: '2026.04.10-1200',
