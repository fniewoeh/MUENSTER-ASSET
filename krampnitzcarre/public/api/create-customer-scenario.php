...
try {
    ...
    $storageDir = dirname(__DIR__, 2) . DIRECTORY_SEPARATOR . 'Krampnitzcarre-data' . DIRECTORY_SEPARATOR . 'customer-scenarios';
    ...
    respond(201, [
        'id' => $scenarioId,
        'path' => '/Krampnitzcarre-data/customer-scenarios/' . $scenarioId . '.json',
    ]);
} catch (JsonException) {
