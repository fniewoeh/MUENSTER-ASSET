...
try {
    ...
    $storageDir = dirname(__DIR__, 2) . DIRECTORY_SEPARATOR . 'TQ-Home-data' . DIRECTORY_SEPARATOR . 'customer-scenarios';
    ...
    respond(201, [
        'id' => $scenarioId,
        'path' => '/TQ-Home-data/customer-scenarios/' . $scenarioId . '.json',
    ]);
} catch (JsonException) {
