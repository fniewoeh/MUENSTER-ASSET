...
try {
    ...
    $storageDir = dirname(__DIR__, 2) . DIRECTORY_SEPARATOR . 'krampnitzcarre2-data' . DIRECTORY_SEPARATOR . 'customer-scenarios';
    ...
    respond(201, [
        'id' => $scenarioId,
        'path' => '/krampnitzcarre2-data/customer-scenarios/' . $scenarioId . '.json',
    ]);
} catch (JsonException) {
