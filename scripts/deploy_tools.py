...
def parse_args() -> argparse.Namespace:
  parser = argparse.ArgumentParser(description="Build and deploy tools/dist to Strato over SFTP.")
  parser.add_argument("--target", default=DEFAULT_TARGET, help="Remote target dir. Defaults to /tools.")
  parser.add_argument(
    "--credentials-file",
