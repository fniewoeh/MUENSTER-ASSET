...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build and deploy krampnitzcarre/dist to Strato over SFTP."
    )
    parser.add_argument(
        "--target",
        default=DEFAULT_TARGET,
        help="Remote target dir. Defaults to /Krampnitzcarre.",
    )
    parser.add_argument(
        "--credentials-file",
